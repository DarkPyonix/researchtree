...
<table>
  ...
  <tr><td>🗺️ <b>평면 보기</b></td><td><b>평면 보기</b>를 누르면 카메라가 위에서 내려다보는 시점으로 돌며 식물이 납작하게 눌립니다. 땅, 물, 나루터와 나룻배, 장식은 사라지고 흙길, 텃밭, 버전 돌, 라벨 칩만 남습니다. 바다를 건너는 길은 점선 길 타일로 그려져 가지가 끊기지 않습니다. 평면에서는 이동과 확대만 됩니다. <b>입체 보기</b>를 누르면 섬이 다시 솟아오릅니다. 어느 쪽이든 선택 상태는 유지됩니다.</td></tr>

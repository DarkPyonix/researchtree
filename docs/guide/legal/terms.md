...
ResearchTree is free software under the [Apache License 2.0](https://github.com/DarkPyonix/researchtree/blob/main/LICENSE). The license governs your rights to use, copy, modify, and distribute the code. These terms add only what the hosted services need.
...
- Everything you create with ResearchTree (pull requests, comments, branches, tags) lives in your GitHub repository and remains yours. It is subject to [GitHub's Terms of Service](https://docs.github.com/site-policy/github-terms/github-terms-of-service) and your repository's own rules.
...
How ResearchTree handles data is described in the [Privacy Policy](./privacy).

## Changes and contact

We may update these terms; the effective date above shows the latest version, and the history is public in the [repository](https://github.com/DarkPyonix/researchtree/commits/main/docs/guide/legal/terms.md). Questions: [open an issue](https://github.com/DarkPyonix/researchtree/issues).
...
ResearchTree는 [Apache License 2.0](https://github.com/DarkPyonix/researchtree/blob/main/LICENSE)을 따르는 자유 소프트웨어예요. 코드를 쓰고, 복사하고, 고치고, 배포할 권리는 라이선스를 따르고, 이 약관은 호스팅 서비스에 필요한 내용만 더해요.
...
- ResearchTree로 만든 모든 것(PR, 댓글, 브랜치, 태그)은 여러분의 GitHub 레포에 있고 여러분의 것이에요. [GitHub 이용약관](https://docs.github.com/site-policy/github-terms/github-terms-of-service)과 레포 자체 규칙을 따라요.
...
데이터를 어떻게 다루는지는 [개인정보 처리방침](./privacy)에 있어요.

### 변경과 문의

약관을 고칠 수 있으며, 위의 시행일이 최신 버전이고 이력은 [레포](https://github.com/DarkPyonix/researchtree/commits/main/docs/guide/legal/terms.md)에 공개돼요. 문의는 [이슈](https://github.com/DarkPyonix/researchtree/issues)로 남겨 주세요.
